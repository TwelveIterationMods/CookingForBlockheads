...
public class OvenRecipe implements Recipe<SingleRecipeInput> {
    ...
    public OvenRecipe(Ingredient ingredient, ItemStackTemplate resultItem) {
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, OvenRecipe> STREAM_CODEC = StreamCodec.of(OvenRecipe::toNetwork,
    ...
    public static RecipeSerializer<OvenRecipe> serializer() {
