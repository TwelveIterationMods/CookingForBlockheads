...
public class ModItemTags {
    ...
    public static final TagKey<Item> SINKS = TagKey.create(Registries.ITEM, new ResourceLocation(CookingForBlockheads.MOD_ID, "sinks"));
    public static final TagKey<Item> DYED_SINKS = TagKey.create(Registries.ITEM, new ResourceLocation(CookingForBlockheads.MOD_ID, "dyed_sinks"));
