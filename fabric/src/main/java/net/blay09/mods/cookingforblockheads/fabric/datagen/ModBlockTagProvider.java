...
public class ModBlockTagProvider extends FabricTagProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "oak_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "oak_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "oak_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "oak_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "oak_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "oak_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "spruce_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "spruce_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "spruce_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "spruce_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "spruce_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "spruce_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "birch_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "birch_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "birch_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "birch_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "birch_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "birch_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "jungle_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "jungle_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "jungle_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "jungle_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "jungle_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "jungle_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "acacia_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "acacia_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "acacia_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "acacia_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "acacia_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "acacia_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "dark_oak_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "dark_oak_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "dark_oak_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "dark_oak_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "dark_oak_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "dark_oak_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "mangrove_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "mangrove_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "mangrove_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "mangrove_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "mangrove_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "mangrove_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "cherry_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "cherry_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "cherry_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "cherry_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "cherry_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "cherry_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "bamboo_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "bamboo_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "bamboo_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "bamboo_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "bamboo_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "bamboo_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "crimson_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "crimson_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "crimson_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "crimson_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "crimson_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "crimson_half_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "warped_full_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "warped_full_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "warped_full_drawers_4"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "warped_half_drawers_1"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "warped_half_drawers_2"));
        kitchenItemProviders.addOptional(ResourceLocation.fromNamespaceAndPath("storagedrawers", "warped_half_drawers_4"));
