...
dependencies {
    ...
    // Forge: implementation "curse.maven:cooking-for-blockheads-231484:${cookingforblockheads_file_id}"
...
dependencies {
    ...
    // Forge: implementation "net.blay09.mods:cookingforblockheads-forge:${cookingforblockheads_version}"
